...
public abstract class DbDriver
{
    ...
    public string GetCsharpType(Column column)
    {
        ...
        string GetTypeWithoutNullableSuffix()
        {
            ...
            foreach (var columnMapping in ColumnMappings
                         .Where(columnMapping => DoesColumnMappingApply(columnType, columnMapping, column)))
            {
    ...
    private static bool DoesColumnMappingApply(string columnType, ColumnMapping columnMapping, Column column)
    {
