// auto-generated by sqlc at 08/04/2024 12:17 - do not edit
...
public class QuerySql(string connectionString)
{
    ...
    {
        {
            ...
            {
                var read = (int)reader.GetBytes(ordinal, bufferSize + bytesRead, buffer, offset,
    ...
    public readonly record struct TestRow(
        byte[]? C_bit,
        int? C_tinyint,
        int? C_bool,
        int? C_boolean,
