...
public class QuerySql(string connectionString)
{
    ...
    {
        {
            await using var connection = new MySqlConnection(connectionString)connection.Open()await using var command = new MySqlCommand(ListAuthorsSql, connection);
            var reader = await command.ExecuteReaderAsync();
    ...
    {
        {
            await using var connection = new MySqlConnection(connectionString)connection.Open()await using var command = new MySqlCommand(CreateAuthorSql, connection);
    ...
    {
        {
            await using var connection = new MySqlConnection(connectionString)connection.Open()await using var command = new MySqlCommand(UpdateAuthorSql, connection);
            command.Parameters.AddWithValue("@bio", args.Bio);
            command.Parameters.AddWithValue("@id", args.Id);
            await command.ExecuteScalarAsync();
        }
    ...
    {
        {
            await using var connection = new MySqlConnection(connectionString)connection.Open()await using var command = new MySqlCommand(DeleteAuthorSql, connection);
            command.Parameters.AddWithValue("@id", args.Id);
            await command.ExecuteScalarAsync();
        }
    }
