...
public class SqliteWriteBenchmark : BaseWriteBenchmark
{
    ...
    {
        yield return new WriteBenchmarkArgs(TotalRecordsToLoad: TotalRecordsForSetup, BatchSize: 50);
        yield return new WriteBenchmarkArgs(TotalRecordsToLoad: TotalRecordsForSetup, BatchSize: 100);
    }
