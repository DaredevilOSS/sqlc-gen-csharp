...
public class CodeGenerator
{
    ...
    public CodeGenerator(GenerateRequest generateRequest)
    {
        ...
        CsprojGen = new CsprojGen(GenerateRequest.Settings.Codegen.Out, Options.DriverName, Options.DotnetFramework);
    ...
    private File GenerateFile(string namespaceName, IEnumerable<Query> queries, string className)
    {
        ...
        var root = CompilationRootGen(namespaceName, usingDirectives, classDeclaration);
    ...
    private CompilationUnitSyntax CompilationRootGen(string namespaceName, UsingDirectiveSyntax[] usingDirectives, 
        MemberDeclarationSyntax classDeclaration)
    {
        return Options.DotnetFramework == DotnetFramework.Dotnet80 
            ? CompilationUnit()
                .AddUsings(usingDirectives)
                .AddMembers(FileScopedNamespaceDeclaration(IdentifierName(namespaceName)), classDeclaration)
                .NormalizeWhitespace()
            : CompilationUnit()
                .AddMembers(
