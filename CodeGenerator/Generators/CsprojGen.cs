...
internal class CsprojGen(string projectName, Options options)
{
    ...
    {
        var nullableProperty = options.DotnetFramework == DotnetFramework.Dotnet80 ? "enable" : "disable";
        return $"""
                ...
                <Project Sdk="Microsoft.NET.Sdk">
                    ...
                    <PropertyGroup>
                        <TargetFramework>{options.DotnetFramework.StandardName()}</TargetFramework>
