    ...
    public static Dictionary<KnownTestType, TestImpl> TestImplementations { get; } = new()
    {
        [KnownTestType.PostgresStringDataTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresStringTypesAsync(
                         string cChar, 
                         string cVarchar, 
                         ...
                         string cText)
                     {
                         await QuerySql.InsertPostgresStringTypesAsync(new QuerySql.InsertPostgresStringTypesArgs
                         {
                             CChar = cChar,
                             CVarchar = cVarchar,
        ...
        [KnownTestType.PostgresIntegerDataTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresIntegerTypesAsync(
                         bool cBoolean,
                         short cSmallint, 
                         int cInteger,
                         long cBigint)
                     {
                         await QuerySql.InsertPostgresNumericTypesAsync(new QuerySql.InsertPostgresNumericTypesArgs
                         {
                             CBoolean = cBoolean,
                             CSmallint = cSmallint,
                             CInteger = cInteger,
        ...
        [KnownTestType.PostgresFloatingPointDataTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     [TestCase(null, null, null, null, null)]
                     public async Task TestPostgresFloatingPointTypesAsync(
                         float? cReal, 
                         decimal? cNumeric, 
                         decimal? cDecimal, 
        ...
        [KnownTestType.PostgresDateTimeDataTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresDateTimeTypesAsync(
                         DateTime? cDate,
                         TimeSpan? cTime, 
                         DateTime? cTimestamp,
                     ...
                     {
                         await QuerySql.InsertPostgresDateTimeTypesAsync(new QuerySql.InsertPostgresDateTimeTypesArgs
                         {
                             CDate = cDate,
                             CTime = cTime,
        ...
        [KnownTestType.PostgresArrayDataTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresArrayTypesAsync(
                         byte[] cBytea,
                         bool[] cBooleanArray,
                         string[] cTextArray,
                         int[] cIntegerArray,
                     ...
                     {
                         await QuerySql.InsertPostgresArrayTypesAsync(new QuerySql.InsertPostgresArrayTypesArgs
                         {
                             CBytea = cBytea,
        ...
        [KnownTestType.PostgresStringCopyFrom] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestStringCopyFromAsync(
                        int batchSize, 
                        string cChar, 
                        string cVarchar, 
                        string cCharacterVarying, 
        ...
        [KnownTestType.PostgresFloatingPointCopyFrom] = new TestImpl
        {
            Impl = $$"""
                     ...
                     [TestCase(10, null, null, null, null, null)]
                     public async Task TestFloatingPointCopyFromAsync(
                        int batchSize, 
                        float? cReal, 
                        decimal? cDecimal, 
                        decimal? cNumeric, 
        ...
        [KnownTestType.PostgresDateTimeCopyFrom] = new TestImpl
        {
            Impl = $$"""
                     ...
                     [TestCase(10, null, null, null, null, null)]
                     public async Task TestDateTimeCopyFromAsync(
                        int batchSize, 
                        DateTime? cDate, 
                        TimeSpan? cTime, 
                        DateTime? cTimestamp, 
                        ...
                        TimeSpan? cInterval)
                     {
                         ...
                         var batchArgs = Enumerable.Range(0, batchSize)
                             .Select(_ => new QuerySql.InsertPostgresDateTimeTypesBatchArgs
                             {
                                 CDate = cDate,
                                 CTime = cTime,
                                 CTimestamp = cTimestamp,
        ...
        [KnownTestType.PostgresJsonDataTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     [TestCase(null, null)]
                     public async Task TestPostgresJsonDataTypesAsync(
                        string cJson,
                        string cJsonpath)
                     {
                         ...
                         await QuerySql.InsertPostgresSpecialTypesAsync(new QuerySql.InsertPostgresSpecialTypesArgs
                         {
                             CJson = cParsedJson,
                             CJsonb = cParsedJson,
            ...
            Impl = $$"""
                     ...
                     public void TestPostgresInvalidJson()
                     {
                         Assert.ThrowsAsync<Npgsql.PostgresException>(async () => await 
                            QuerySql.InsertPostgresSpecialTypesAsync(new QuerySql.InsertPostgresSpecialTypesArgs
                            {
        ...
        [KnownTestType.PostgresNetworkDataTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresNetworkDataTypesAsync(
                        NpgsqlCidr? cCidr,
                        IPAddress cInet,
                        PhysicalAddress cMacaddr,
                        string cMacaddr8)
                     {
                         await QuerySql.InsertPostgresNetworkTypesAsync(new QuerySql.InsertPostgresNetworkTypesArgs 
                         { 
                             CCidr = cCidr,
                             CInet = cInet, 
                             CMacaddr = cMacaddr, 
        ...
        [KnownTestType.PostgresArrayCopyFrom] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestArrayCopyFromAsync(
                        int batchSize, 
                        byte[] cBytea,
                        bool[] cBooleanArray,
                        string[] cTextArray,
        ...
        [KnownTestType.PostgresGeoCopyFrom] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresGeoCopyFromAsync(
                         int batchSize,
                         NpgsqlPoint? cPoint, 
                         NpgsqlLine? cLine, 
                         NpgsqlLSeg? cLSeg, 
        ...
        [KnownTestType.PostgresDataTypesOverride] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresDataTypesOverrideAsync(
                        int? cInteger,
                        string cVarchar,
                        DateTime cTimestamp)
                     {
        ...
        [KnownTestType.PostgresNetworkCopyFrom] = new TestImpl
        {
            Impl = $$"""
                     ...
                     public async Task TestPostgresNetworkCopyFromAsync(
                        int batchSize, 
                        NpgsqlCidr? cCidr,
                        IPAddress cInet,
                        PhysicalAddress cMacaddr)
                     {
                         var batchArgs = Enumerable.Range(0, batchSize)
                             .Select(_ => new QuerySql.InsertPostgresNetworkTypesBatchArgs
                             {
                                 CCidr = cCidr,
                                 CInet = cInet,
                                 CMacaddr = cMacaddr
        ...
        [KnownTestType.PostgresNotNullTypes] = new TestImpl
        {
            Impl = $$"""
                     ...
                     {
                         await QuerySql.InsertPostgresNotNullTypesAsync(new QuerySql.InsertPostgresNotNullTypesArgs
                         {
            ...
            Impl = $$"""
                     ...
                     public async Task TestPostgresFullTextSearchDataTypesAsync()
                     {
                         ...
                         var actual = await QuerySql.GetPostgresStringTypesTextSearchAsync(
                            new QuerySql.GetPostgresStringTypesTextSearchArgs { ToTsquery = "Hello" });
